...
describe.only('/GET /farms/:farmId/data', () => {
  let farm;
  let newData;
  ...
  describe('defaultScope', () => {
    it('should return a user without the id, createdAt or updatedAt field', async () => {
      ...
      expect(response.body.data[0]).to.not.have.property('createdAt');
      expect(response.body.data[0]).to.not.have.property('updatedAt');
    });
  });
});